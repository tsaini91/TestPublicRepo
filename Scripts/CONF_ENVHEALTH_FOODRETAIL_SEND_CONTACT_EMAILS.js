    ...
    "WorkflowTaskUpdateAfter": [
      {
        ...
        "preScript": "var envVarName = "customEmailParams";
	var eParamsTest = aa.util.newHashtable();
	var itemCapIDString = capId.getCustomID();
	addParameter(eParamsTest, "$$myAltID$$", itemCapIDString);
	logDebug("(addCustomEmailParams) = " + itemCapIDString);
	aa.env.setValue(envVarName, eParamsTest);",
        "criteria": {
          "task": [],
          "status": [
	  ...
	  "customEmailParamsVariable": "customEmailParams"
        },
        "postScript": ""
      },
      {
